...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Pattern pattern1 = Pattern.compile("[0-5]{1}");
        ...
        do {
            do {
                System.out.println("\n1) print out my matrix;" +
                        "\n2) print out the matrix by snake (bottom-up); " +
                        "\n3) print out the matrix by snake (top-down);" +
                        "\n4) print out the matrix by spiral;" +
                        "\n5) save the matrix to file" +
                        "\n0) exit the program");
