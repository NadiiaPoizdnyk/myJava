...
public class Oscillograph {
    ...
    public void setUp()throws Exception{
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);    //waiter for 30 seconds
    }
    ...
    public void googleSearch()throws Exception {
        ...
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);     //waiter for 5 seconds
